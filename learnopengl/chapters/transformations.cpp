...
int main() {
    ...
    while(!glfwWindowShouldClose(window)){
        ...
        // important convention: the transformation pipeline is to be read in reverse
        // e.g. here it's: rotation -> translation
        glm::mat4 trans = glm::mat4(1.0f);
        trans = glm::translate(trans, glm::vec3(0.5f, -0.5f, 0.0f));
        trans = glm::rotate(trans, (float)t*4, glm::vec3(0.0, 0.0, 1.0));
        trans = glm::scale(trans, glm::vec3(1.0, 0.5, 1.0));
        ...
        float scalingFactor = sin(t)/2.0 + 0.5;
        trans = glm::mat4(1.0f);
        trans = glm::scale(trans, glm::vec3(scalingFactor, scalingFactor, 1.0));
        trans = glm::translate(trans, glm::vec3(-0.5f*cos(t), 0.5f*sin(t), 0.0f));
        ourShader.setMat4("transform", trans);
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);
